...
const DEFAULT_GLOW_COLOR = '177, 158, 239'; // #B19EEF purple
const MOBILE_BREAKPOINT = 768;

// Customized for Invoice Finance Platform
const cardData: BentoCardProps[] = [
    {
        color: '#060010',
        title: 'Privy Wallet Integration',
        description: 'Seamless embedded wallet onboarding with social logins',
        label: 'Auth'
    },
    {
        color: '#060010',
        title: 'KYC Verification',
        description: 'Regulatory compliant identity verification for businesses',
        label: 'Compliance'
    },
    {
        color: '#060010',
        title: 'Smart Contract Escrow',
        description: 'Automated trustless invoice financing with secure fund holding',
        label: 'Security'
    },
    {
        color: '#060010',
        title: 'Real-Time Streaming',
        description: 'Continuous repayment flows as invoices get paid',
        label: 'Payments'
    },
    {
        color: '#060010',
        title: 'Mantle Integration',
        description: 'Low-cost transactions on high-performance L2',
        label: 'Blockchain'
    },
    {
        color: '#060010',
        title: 'Invoice Tokenization',
        description: 'Convert invoices into tradeable on-chain assets',
        label: 'DeFi'
    }
];
...
const BentoCardGrid: React.FC<{
    ...
    <div
        className="bento-section grid gap-2 p-3 max-w-[70rem] w-full select-none relative mx-auto"
    ...
    return (
        <>
          ...
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%);
            --purple-primary: rgba(177, 158, 239, 1);
            --purple-glow: rgba(177, 158, 239, 0.2);
            --purple-border: rgba(177, 158, 239, 0.8);
          }
